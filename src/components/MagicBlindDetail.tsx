...
const GALLERY_IMAGES = Array.from({ length: 30 }, (_, i) => ({
  src: `/images/magic-blind/img-${String(i + 1).padStart(2, '0')}.jpg`,
  alt: `매직블라인드 시공 사례 ${i + 1}`,
}));
...
const FEATURES = [
  {
    title: '원터치 빛 조절',
    desc: '슬라이드 하나로 채광량을 자유롭게 조절합니다. 완전 개방부터 완전 차단까지 부드럽게 전환됩니다.',
    icon: '◎',
  },
  {
    title: '슬림 디자인',
    desc: '최소한의 두께로 창문에 밀착 설치되어 공간을 넓게 활용할 수 있습니다. 모던 인테리어에 완벽한 조화를 이룹니다.',
    icon: '▯',
  },
  {
    title: '다양한 패턴',
    desc: '우드, 패브릭, 메탈릭 등 다양한 질감과 패턴으로 공간의 개성을 표현할 수 있습니다.',
    icon: '✧',
  },
  {
    title: '간편한 관리',
    desc: '정전기 방지 처리된 원단으로 먼지가 잘 붙지 않으며, 부드러운 천으로 간단히 관리할 수 있습니다.',
    icon: '◇',
  },
];

const SPECS = [
  { label: '구조', value: '이중 원단 슬라이드' },
  { label: '소재', value: '프리미엄 패브릭' },
  { label: '빛 조절', value: '무단계 조절' },
  { label: '작동', value: '수동 / 전동 선택' },
  { label: '패턴', value: '20가지 이상' },
  { label: '관리', value: '정전기 방지 처리' },
];

interface MagicBlindDetailProps {
  onNavigate: (page: string) => void;
}

export default function MagicBlindDetail({ onNavigate }: MagicBlindDetailProps) {
    ...
    <div className="bg-white">
      ...
      <section ref={heroRef} className="relative h-[85vh] overflow-hidden">
        <motion.div className="absolute inset-0" style={{ y: heroY }}>
          <img
            src="/images/magic-blind/img-01.jpg"
            alt="매직블라인드 히어로"
        ...
        <motion.div className="relative h-full flex flex-col justify-end pb-16 px-6 md:px-16" style={{ opacity: heroOpacity }}>
          <div className="max-w-4xl">
            ...
            >
              마법같은 빛의 조절.<br className="hidden md:block" />
              슬라이드 하나로 연출하는 완벽한 빛의 예술.
            </motion.p>
            <motion.div
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <SectionReveal>
                <span className="text-xs font-bold tracking-[0.3em] text-amber-800 uppercase">About Magic Blind</span>
                <h2 className="text-3xl md:text-5xl font-serif font-bold text-stone-900 mt-3 mb-6 leading-tight">
                  빛을 마법처럼<br />자유자재로 조절하다
                </h2>
                <div className="space-y-4 text-stone-600 leading-relaxed">
                  <p>
                    이사벨라 매직 블라인드는 혁신적인 원단 구조로 빛의 양을 마법처럼 자유자재로 조절합니다.
                    슬라이드 하나로 완전 채광부터 적절한 차광까지, 원하는 분위기를 순간적으로 연출할 수 있습니다.
                  </p>
                  <p>
                    모던한 인테리어에 완벽하게 어울리는 슬림한 디자인이 특징이며,
                    무단계 조절로 원하는 정확한 광량을 만날 수 있습니다.
                  </p>
                  <p>
                    우드, 패브릭, 메탈릭 등 20가지 이상의 패턴으로 공간의 개성을 표현할 수 있습니다.
                  </p>
                </div>
              </SectionReveal>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <SectionReveal delay={0.1}>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden">
                  <img src="/images/magic-blind/img-08.jpg" alt="매직블라인드" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </SectionReveal>
              <SectionReveal delay={0.2}>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden mt-8">
                  <img src="/images/magic-blind/img-15.jpg" alt="매직블라인드" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </SectionReveal>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <SectionReveal>
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-stone-900 mt-3">매직 블라인드의 특별함</h2>
            </div>
          </SectionReveal>
      ...
      <section className="relative h-[50vh] overflow-hidden">
        <ParallaxImage src="/images/magic-blind/img-05.jpg" alt="매직블라인드 와이드" />
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <p className="text-xs tracking-[0.4em] uppercase mb-3 text-white/60">Seamless Control</p>
            <h3 className="text-3xl md:text-5xl font-serif font-bold">완벽한 조절의 마법</h3>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <SectionReveal>
            ...
            <p className="text-stone-500 mb-10 leading-relaxed">
              전문 컨설턴트가 방문하여 공간에 맞는 최적의 매직 블라인드 설계를 제안해드립니다.<br />
              무료 방문 상담을 신청해 보세요.
            </p>
